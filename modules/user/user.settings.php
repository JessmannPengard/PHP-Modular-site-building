                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <small>
                                            <a href="user.passwordrecovery.php" class="user-link"
                                                data-i18n="forgot password">Have you forgotten your password?</a>
                                        </small>
                                    </div>
                ...
                <form action="" method="post">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <div class="jumbotron">
                                    <h1 class="display-4" data-i18n="delete account">Delete account</h1>
                                    <p class="lead" data-i18n="delete account msg1">This action will permantly delete
                                        your account, you will loose all your data and could not be restored!</p>
                                    <hr class="my-4">
                                    <p data-i18n="delete account msg2">Are you sure you want to continue with this
                                        process?</p>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="d-flex justify-content-center mb-2">
