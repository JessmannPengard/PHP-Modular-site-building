            ...
            <ul class="nav nav-pills flex-column mb-auto">
                <li class="nav-item">
                    <a href="" class="nav-link link-dark active" data-target="account-settings" data-i18n="account">
                        <svg xmlns="http://www.w3.org/2000/svg" class="settings-icon" viewBox="0 0 448 512"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                ...
                <li>
                    <a href="" class="nav-link link-dark" data-target="account-preferences" data-i18n="preferences">
                        <svg xmlns="http://www.w3.org/2000/svg" class="settings-icon" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="d-flex justify-content-center mb-2">
                                            <button type="submit" class="btn btn-primary" data-i18n="save changes">Save
                                                changes</button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-4">
                                <div class="card-body text-center">
                                    <img src="../../upload/profiles/qwerty12345.png" alt="avatar" class="rounded-circle img-fluid" id="settings-profile-picture">
                                    <div class="d-flex justify-content-center mb-2">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="password" name="current-password" class="form-control" maxlength=50 required>
                                        <small>
                                            <a href="user.passwordrecovery.php" class="user-link" data-i18n="forgot password">He
                                                olvidado mi
                                                contraseña</a>
                                        </small>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <?php
                                        $langs = [];
                                        foreach (glob("../translations/lang/*.json") as $file) {
                                            // Get file name (without extension)
                                            $name = basename($file, ".json");
                                            // Get file name of the picture
                                            $image = "../translations/lang/" . $name . ".png";
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="jumbotron">
                                    ...
                                    <p class="lead" data-i18n="delete account msg1">Esta acción borrará su cuenta
                                        definitivamente, ¡perderá todos
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="d-flex justify-content-center mb-2">
                                                ...
                                                <button type="submit" class="btn btn-primary" data-i18n="delete account">Delete account</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
